...
$link = mysqli_connect ($host, $user, $password, "cco") or die ("<center>No se puede conectar con la base de datos\n</center>\n");
...
while ($row = mysqli_fetch_array($result,MYSQL_ASSOC))//loop through the retrieved values
{
